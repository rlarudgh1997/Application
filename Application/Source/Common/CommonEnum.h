...
public:
    enum PropertyType {
        ...
        PropertyTypeReadForDataGeneration,
        ...
        PropertyTypeDetailInfoConvertDescription,
        PropertyTypeDetailInfoConvertPrivates,
        PropertyTypeDetailInfoConvertTelltales,
        PropertyTypeDetailInfoConvertConstants,
        PropertyTypeDetailInfoConvertEvents,
        PropertyTypeDetailInfoConvertSounds,
        PropertyTypeDetailInfoConvertInters,
        PropertyTypeDetailInfoConvertOutputs,
        PropertyTypeDetailInfConvertoMax,
        PropertyTypeListMax,
...
public:
    enum EventType {
        ...
        EventTypeDataStorage,
        EventTypeDataGeneration,
