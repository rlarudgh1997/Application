...
//    Loader {
//        source: {
//            if (vehicleType === VehicleType.VehicleTypePV) {
//                "qrc:/TelltalePV.qml"
//            } else if (vehicleType === VehicleType.VehicleTypeCV) {
//                "qrc:/TelltaleCV.qml"
//            } else {
//                ""
//            }
...
//        visible: updateTelltaleStatus(TelltaleStat.telltaleAFSDBL)
//    }
...
//    }
    ...
    function updateTelltaleStatus(state) {
        if (state === TelltaleStat.ON) {
            return true
        } else {
            return false
        }
