 ...
 */
#ifndef SFSS_EV_Charging_System_H
#define SFSS_EV_Charging_System_H

#define DLOG_ENABLED gEnableSFCLog

#include <cmath>
#include "EV_Charging_SystemBase.hpp"
#include <SFCTimer.h>

namespace ccos {

// SFC Version : 38.0.0
// Reference : [PT170] EV_Charging_System. Contains : Telltale, Constant, Event. Recommend: VALUE_CHANGED
class EV_Charging_System : public EV_Charging_SystemBase {
public:
    EV_Charging_System() = default;
    ~EV_Charging_System() override = default;
    EV_Charging_System(const EV_Charging_System& other) = delete;
    EV_Charging_System(EV_Charging_System&& other) noexcept = delete;
    EV_Charging_System& operator=(const EV_Charging_System& other) = delete;
    EV_Charging_System& operator=(EV_Charging_System&& other) noexcept = delete;

    void onInitialize() override {
        if (mOneShotTimerPrivateChargingStatus.create(kTimerPrivateChargingStatusInterval60s, this,
                                                      &EV_Charging_System::onOneShotTimerPrivateChargingStatus) == false) {
            DWarning() << "[EV_Charging_System] mOneShotTimerPrivateChargingStatus Create Failed";
        }
        setSFCEV_Charging_SystemEventEvChargeFailWarnObcLinkedSoundID("SND_PopUpWarn1");
        setSFCEV_Charging_SystemEventEvChargeFailWarnObcLinkedSoundType(
            SFCEV_Charging_SystemEventEvChargeFailWarnObcLinkedSoundType::REPEAT_COUNT);
        setSFCEV_Charging_SystemEventEvChargeFailWarnObcLinkedSoundRepeatCount(1);
        setSFCEV_Charging_SystemEventEvChargeFailWarnLinkedSoundID("SND_PopUpWarn1");
        setSFCEV_Charging_SystemEventEvChargeFailWarnLinkedSoundType(
            SFCEV_Charging_SystemEventEvChargeFailWarnLinkedSoundType::REPEAT_COUNT);
        setSFCEV_Charging_SystemEventEvChargeFailWarnLinkedSoundRepeatCount(1);
        setSFCEV_Charging_SystemTelltaleEvChgCableStat(SFCEV_Charging_SystemTelltaleEvChgCableStat::OFF);
        setSFCEV_Charging_SystemEventEvShiftPToChargeReqID("E22101");
        setSFCEV_Charging_SystemEventEvShiftPToChargeReqLinkedSoundID("SND_PopUpInform2");
        setSFCEV_Charging_SystemEventEvShiftPToChargeReqLinkedSoundType(
            SFCEV_Charging_SystemEventEvShiftPToChargeReqLinkedSoundType::REPEAT_COUNT);
        setSFCEV_Charging_SystemEventEvShiftPToChargeReqLinkedSoundRepeatCount(1);
        setSFCEV_Charging_SystemEventEvChargeDoorMalfunctionLinkedSoundID("SND_PopUpWarn1");
        setSFCEV_Charging_SystemEventEvChargeDoorMalfunctionLinkedSoundType(
            SFCEV_Charging_SystemEventEvChargeDoorMalfunctionLinkedSoundType::REPEAT_COUNT);
        setSFCEV_Charging_SystemEventEvChargeDoorMalfunctionLinkedSoundRepeatCount(1);
        setSFCEV_Charging_SystemEventEvChargeSchedWaitID("E22110");
        setSFCEV_Charging_SystemEventEvChargeSchedWaitLinkedSoundID("SND_PopUpInform2");
        setSFCEV_Charging_SystemEventEvChargeSchedWaitLinkedSoundType(
            SFCEV_Charging_SystemEventEvChargeSchedWaitLinkedSoundType::REPEAT_COUNT);
        setSFCEV_Charging_SystemEventEvChargeSchedWaitLinkedSoundRepeatCount(1);
        setSFCEV_Charging_SystemEventEvChargeLinkedSoundID("SND_PopUpInform2");
        setSFCEV_Charging_SystemEventEvChargeLinkedSoundType(SFCEV_Charging_SystemEventEvChargeLinkedSoundType::REPEAT_COUNT);
        setSFCEV_Charging_SystemEventEvChargeLinkedSoundRepeatCount(1);
        setSFCEV_Charging_SystemEventEvFastChargeFailWarnLinkedSoundID("SND_PopUpInform2");
        setSFCEV_Charging_SystemEventEvFastChargeFailWarnLinkedSoundType(
            SFCEV_Charging_SystemEventEvFastChargeFailWarnLinkedSoundType::REPEAT_COUNT);
        setSFCEV_Charging_SystemEventEvFastChargeFailWarnLinkedSoundRepeatCount(1);
        setSFCEV_Charging_SystemEventEvChgCalculateErrorLinkedSoundID("SND_PopUpWarn1");
        setSFCEV_Charging_SystemEventEvChgCalculateErrorLinkedSoundType(
            SFCEV_Charging_SystemEventEvChgCalculateErrorLinkedSoundType::REPEAT_COUNT);
        setSFCEV_Charging_SystemEventEvChgCalculateErrorLinkedSoundRepeatCount(1);
        setSFCEV_Charging_SystemEventEvUnreliableSocWarnLinkedSoundID("SND_PopUpWarn1");
        setSFCEV_Charging_SystemEventEvUnreliableSocWarnLinkedSoundType(
            SFCEV_Charging_SystemEventEvUnreliableSocWarnLinkedSoundType::REPEAT_COUNT);
        setSFCEV_Charging_SystemEventEvUnreliableSocWarnLinkedSoundRepeatCount(1);
        setSFCEV_Charging_SystemEventV2LCInoperableAndRunningLinkedSoundType(
            SFCEV_Charging_SystemEventV2LCInoperableAndRunningLinkedSoundType::REPEAT_COUNT);
        setSFCEV_Charging_SystemEventV2LCInoperableAndRunningLinkedSoundRepeatCount(1);
        setSFCEV_Charging_SystemEventV2LCTailgateID("E22131");
        setSFCEV_Charging_SystemEventV2LCTailgateLinkedSoundID("SND_PopUpWarn1");
        setSFCEV_Charging_SystemEventV2LCTailgateLinkedSoundType(
            SFCEV_Charging_SystemEventV2LCTailgateLinkedSoundType::REPEAT_COUNT);
        setSFCEV_Charging_SystemEventV2LCTailgateLinkedSoundRepeatCount(1);
    }
    ...
    void onEvChargeSchedHourChanged(const ArgumentsEvChargeSchedHourChanged& args) {
        mTimeDisplayInformationFromAvn = args.mInput_TimeDisplayInformationFromAvn;
        mEvChargeSchedHourValue = args.mInput_EvChargeSchedHourValue;

        updateConstantEvChargeSchedHour();
    }
    ...
    void onV2LCMinimumSocValueChanged(const ArgumentsV2LCMinimumSocValueChanged& args) {
        mV2LCMinimumSocValue = args.mInput_V2LCMinimumSocValue;
        updateConstantV2LCMinimumSoc();
    }
    ...
    void onV2LCChargingInfoStatusChanged(const ArgumentsV2LCChargingInfoStatusChanged& args) {
        if (ISTIMEOUT(args.mInput_V2lcChargingInfoStatus) == true) {
            mV2lcChargingInfoStatus = V2lcChargingInfoStatus::UNHANDLED_TIMEOUT;
        } else {
            mV2lcChargingInfoStatus = args.mInput_V2lcChargingInfoStatus;
        }
        updateConstantV2LCFcevChargingStat();
    }
...
private:
    ...
    void updatePrivateChargingStatus() {
        ...
        if (mPrivateChargingDisplayStatus == ChargingDisplayStatus::ON_INFINITE) {
            ...
            if (mOneShotTimerPrivateChargingStatus.start() == false) {
                DWarning() << "[EV_Charging_System] mOneShotTimerPrivateChargingStatus Start Failed";
            }
        } else {
            mPrivateChargingStatus = ChargingStatus::OFF;
            mOneShotTimerPrivateChargingStatus.stop();
    ...
    void updateTelltaleEvChgCable() {
        if (mIgnElapsed == IgnElapsed::ON_0ms) {
            ...
            setSFCEV_Charging_SystemTelltaleEvChgCableStat(SFCEV_Charging_SystemTelltaleEvChgCableStat::ON);
    ...
    void updateConstantChargingRemainTime() {
        SFCEV_Charging_SystemConstantChargingRemainTimeStat timeStat =
            SFCEV_Charging_SystemConstantChargingRemainTimeStat::DISPLAY_OFF;
        ...
        if (mEvChargeFinishStatus == EvChargeFinishStatus::NORMAL) {
            if (mEvStdChargeRemainTimeValue == kEvStdChargeRemainTimeValue0 ||
                ...
                timeStat = SFCEV_Charging_SystemConstantChargingRemainTimeStat::UNMEASURABLE;
                ...
                timeStat = SFCEV_Charging_SystemConstantChargingRemainTimeStat::VALUE;
                setSFCEV_Charging_SystemConstantChargingRemainTimeValue(mEvStdChargeRemainTimeValue);
                ...
                timeStat = SFCEV_Charging_SystemConstantChargingRemainTimeStat::VALUE;
                setSFCEV_Charging_SystemConstantChargingRemainTimeValue(kEvStdChargeRemainTimeValue59999);
            } else {
                // DISPLAY_OFF
            }
        } else if (mEvChargeFinishStatus == EvChargeFinishStatus::FINISHED) {
            if (mEvStdChargeRemainTimeValue == kEvStdChargeRemainTimeValue0) {
                timeStat = SFCEV_Charging_SystemConstantChargingRemainTimeStat::MIN;
            } else if (mEvStdChargeRemainTimeValue >= kEvStdChargeRemainTimeValue1 &&
                       mEvStdChargeRemainTimeValue <= kEvStdChargeRemainTimeValue59999) {
                timeStat = SFCEV_Charging_SystemConstantChargingRemainTimeStat::VALUE;
                setSFCEV_Charging_SystemConstantChargingRemainTimeValue(mEvStdChargeRemainTimeValue);
        ...
        setSFCEV_Charging_SystemConstantChargingRemainTimeStat(timeStat);
    }

    // 5.2.1.2 잔여 충전 시간(80%)
    void updateConstantCharging80SocTime() {
        mSFCEV_Charging_SystemConstantCharging80SocTimeStat = SFCEV_Charging_SystemConstantCharging80SocTimeStat::DISPLAY_OFF;
        ...
        if (mPrivateDisplay80SocStatus == Display80SocStatus::ON) {
            if (mEvChargeFinishStatus == EvChargeFinishStatus::NORMAL) {
                if (mEvBulkChargeRemainTimeValue == kEvBulkChargeRemainTimeValue0 ||
                    ...
                    mSFCEV_Charging_SystemConstantCharging80SocTimeStat =
                        SFCEV_Charging_SystemConstantCharging80SocTimeStat::UNMEASURABLE;
                    ...
                    mSFCEV_Charging_SystemConstantCharging80SocTimeStat =
                        SFCEV_Charging_SystemConstantCharging80SocTimeStat::VALUE;
                    setSFCEV_Charging_SystemConstantCharging80SocTimeValue(mEvBulkChargeRemainTimeValue);
                } else {
                    // nothing
                }
            } else if (mEvChargeFinishStatus == EvChargeFinishStatus::FINISHED) {
                if (mEvBulkChargeRemainTimeValue == kEvBulkChargeRemainTimeValue0) {
                    mSFCEV_Charging_SystemConstantCharging80SocTimeStat = SFCEV_Charging_SystemConstantCharging80SocTimeStat::MIN;
                } else if (mEvBulkChargeRemainTimeValue >= kEvBulkChargeRemainTimeValue1 &&
                           mEvBulkChargeRemainTimeValue <= kEvBulkChargeRemainTimeValue65534) {
                    mSFCEV_Charging_SystemConstantCharging80SocTimeStat =
                        SFCEV_Charging_SystemConstantCharging80SocTimeStat::VALUE;
        ...
        setSFCEV_Charging_SystemConstantCharging80SocTimeStat(mSFCEV_Charging_SystemConstantCharging80SocTimeStat);
        updateConstantChargingEightyPercentDte();
    }

    // 5.2.1.3 목표(최대) 충전량 / Target (max) charge
    void updateConstantChargingMaxSoc() {
        SFCEV_Charging_SystemConstantChargingMaxSocStat stat = SFCEV_Charging_SystemConstantChargingMaxSocStat::UNMEASURABLE;
        HUInt64 value = 0;
        ...
        if (mEvFastChargeStatus == EvFastChargeStatus::CHARGING && mEvStdChargeStatus == EvStdChargeStatus::OFF &&
            ...
            stat = SFCEV_Charging_SystemConstantChargingMaxSocStat::VALUE;
        ...
        setSFCEV_Charging_SystemConstantChargingMaxSocStat(stat);
        setSFCEV_Charging_SystemConstantChargingMaxSocValue(value);
    }

    // 5.2.1.4 현재 충전량
    void updateConstantChargingCurrentSoc() {
        SFCEV_Charging_SystemConstantChargingCurrentSocStat stat =
            SFCEV_Charging_SystemConstantChargingCurrentSocStat::UNMEASURABLE;
        HUInt64 value = 0;

        if (mEvSocDisplayValue >= kEvSocDisplayValue0 && mEvSocDisplayValue <= kEvSocDisplayValueLimit) {
            stat = SFCEV_Charging_SystemConstantChargingCurrentSocStat::VALUE;
            value = mEvSocDisplayValue / 2;  // floor
        }
        setSFCEV_Charging_SystemConstantChargingCurrentSocStat(stat);
        setSFCEV_Charging_SystemConstantChargingCurrentSocValue(value);
    }

    // 5.2.1.5 충전 전력량
    void updateConstantChargingPwr() {
        SFCEV_Charging_SystemConstantChargingPwrStat stat = SFCEV_Charging_SystemConstantChargingPwrStat::DISPLAY_OFF;
        HDouble value = 0.0;
        ...
        if (mConfigVehicleType == ConfigVehicleType::PHEV) {
            if (mEvStdChargeInputPowerValue >= kEvChargingValue1 && mEvStdChargeInputPowerValue <= kEvChargingValue254) {
                stat = SFCEV_Charging_SystemConstantChargingPwrStat::VALUE;
                ...
                stat = SFCEV_Charging_SystemConstantChargingPwrStat::UNMEASURABLE;
            } else {
                // nothing
            }
        ...
        setSFCEV_Charging_SystemConstantChargingPwrStat(stat);
        setSFCEV_Charging_SystemConstantChargingPwrValue(value);
    }

    // 5.2.1.6 목표(최대) 충전량 예상 DTE
    void updateConstantChargingMaxDte() {
        SFCEV_Charging_SystemConstantChargingMaxDteStat stat = SFCEV_Charging_SystemConstantChargingMaxDteStat::DISPLAY_OFF;
        HUInt64 value = 0;
        ...
        if (mEvFastChargeStatus == EvFastChargeStatus::CHARGING && mEvStdChargeStatus == EvStdChargeStatus::OFF &&
            ...
            if (mTripDistanceUnit == TripDistanceUnit::KM) {
                stat = SFCEV_Charging_SystemConstantChargingMaxDteStat::VALUE;
        ...
        setSFCEV_Charging_SystemConstantChargingMaxDteStat(stat);
        setSFCEV_Charging_SystemConstantChargingMaxDteValue(value);
    }

    // 5.2.1.7 80% 충전량 예상 DTE
    void updateConstantChargingEightyPercentDte() {
        SFCEV_Charging_SystemConstantChargingEightyPercentDteStat stat =
            SFCEV_Charging_SystemConstantChargingEightyPercentDteStat::DISPLAY_OFF;
        HUInt64 value = 0;
        if (mSFCEV_Charging_SystemConstantCharging80SocTimeStat !=
            SFCEV_Charging_SystemConstantCharging80SocTimeStat::DISPLAY_OFF) {
            if (mTripDistanceUnit == TripDistanceUnit::KM) {
                stat = SFCEV_Charging_SystemConstantChargingEightyPercentDteStat::ON;
        ...
        setSFCEV_Charging_SystemConstantChargingEightyPercentDteStat(stat);
        setSFCEV_Charging_SystemConstantChargingEightyPercentDteValue(value);
    }

    // 5.2.1.8 V2X,V2L 최소 동작 가능 충전량(사용 한도)
    void updateConstantV2LMinimumSoc() {
        SFCEV_Charging_SystemConstantV2LMinimumSocStat stat = SFCEV_Charging_SystemConstantV2LMinimumSocStat::VALUE;
        HUInt64 value = 0;
        ...
        if (mPrivateV2LMinimumSocFromVcmsValue >= kV2LMinimumSocValue1 &&
            ...
            stat = SFCEV_Charging_SystemConstantV2LMinimumSocStat::DISPLAY_OFF;
        }

        setSFCEV_Charging_SystemConstantV2LMinimumSocStat(stat);
        setSFCEV_Charging_SystemConstantV2LMinimumSocValue(value);
    }

    // 5.2.1.9 V2L 사용 가능 시간(사용한도 도달 시간)
    void updateConstantV2LUsingAvailableTimeMin() {
        SFCEV_Charging_SystemConstantV2LUsingAvailableTimeMinStat stat =
            SFCEV_Charging_SystemConstantV2LUsingAvailableTimeMinStat::DISPLAY_OFF;
        HUInt64 value = 0;
        ...
        if (mV2LUsingAvailableTimeMinValue == kV2LUsingAvailableTimeMinValue0 ||
            ...
            stat = SFCEV_Charging_SystemConstantV2LUsingAvailableTimeMinStat::UNMEASURABLE;
            ...
            stat = SFCEV_Charging_SystemConstantV2LUsingAvailableTimeMinStat::VALUE;
        ...
        setSFCEV_Charging_SystemConstantV2LUsingAvailableTimeMinStat(stat);
        setSFCEV_Charging_SystemConstantV2LUsingAvailableTimeMinValue(value);
    }

    // 5.2.1.10 V2L 사용한도 도달 후 잔여 DTE
    void updateConstantV2LRemainDteAfterUse() {
        SFCEV_Charging_SystemConstantV2LRemainDteAfterUseStat stat =
            SFCEV_Charging_SystemConstantV2LRemainDteAfterUseStat::DISPLAY_OFF;
        HUInt64 value = 0;
        ...
        if (mIsV2LRemainDteAfterUseValueTimeout == false) {
            if (mV2LRemainDteAfterUseValue >= kV2LRemainDteAfterUseValue0 &&
                ...
                if (mTripDistanceUnit == TripDistanceUnit::KM) {
                    stat = SFCEV_Charging_SystemConstantV2LRemainDteAfterUseStat::VALUE;
        ...
        setSFCEV_Charging_SystemConstantV2LRemainDteAfterUseStat(stat);
        setSFCEV_Charging_SystemConstantV2LRemainDteAfterUseValue(value);
    }

    // 5.2.1.11.1 V2LC 최소 동작 가능 충전량(사용 한도)
    void updateConstantV2LCMinimumSoc() {
        SFCEV_Charging_SystemConstantV2LCMinimumSocStat stat = SFCEV_Charging_SystemConstantV2LCMinimumSocStat::DISPLAY_OFF;
        HUInt64 value = 0;

        if ((mConfigVehicleType == ConfigVehicleType::HEV || mConfigVehicleType == ConfigVehicleType::PHEV) &&
            mV2LCMinimumSocValue >= 1 && mV2LCMinimumSocValue <= 14) {
            stat = SFCEV_Charging_SystemConstantV2LCMinimumSocStat::ON;
            value = mV2LCMinimumSocValue * 5U;
        } else if (mConfigVehicleType == ConfigVehicleType::FCEV && mV2LCMinimumSocValue >= 1 && mV2LCMinimumSocValue <= 100) {
            stat = SFCEV_Charging_SystemConstantV2LCMinimumSocStat::ON;
            value = mV2LCMinimumSocValue;
        } else {
            // no operation
        }

        setSFCEV_Charging_SystemConstantV2LCMinimumSocStat(stat);
        setSFCEV_Charging_SystemConstantV2LCMinimumSocValue(value);
    }

    // 5.2.1.11.2 V2LC 사용 가능 시간(사용 한도 도달 시간)
    void updateConstantV2LCUsingAvailableTimeMin() {
        SFCEV_Charging_SystemConstantV2LCUsingAvailableTimeMinStat stat =
            SFCEV_Charging_SystemConstantV2LCUsingAvailableTimeMinStat::DISPLAY_OFF;
        HUInt64 value = 0;

        if (mV2LCUsingAvailableTimeMinStatus == V2LCUsingAvailableTimeMinStatus::VALUE) {
            if (mV2LCUsingAvailableTimeMinValue == 0) {
                stat = SFCEV_Charging_SystemConstantV2LCUsingAvailableTimeMinStat::UNMEASURABLE;
            } else if (mV2LCUsingAvailableTimeMinValue >= 1 && mV2LCUsingAvailableTimeMinValue <= 59999) {
                stat = SFCEV_Charging_SystemConstantV2LCUsingAvailableTimeMinStat::ON;
        ...
        setSFCEV_Charging_SystemConstantV2LCUsingAvailableTimeMinStat(stat);
        setSFCEV_Charging_SystemConstantV2LCUsingAvailableTimeMinValue(value);
    }

    // 5.2.1.11.3 V2LC 방전 전력량
    void updateConstantV2LCChargingPwr() {
        SFCEV_Charging_SystemConstantV2LCChargingPwrStat stat = SFCEV_Charging_SystemConstantV2LCChargingPwrStat::DISPLAY_OFF;
        HDouble value = 0.0;

        if (mV2LCChargeInputPowerStatus == V2LCChargeInputPowerStatus::VALUE) {
            if (mV2LCChargeInputPowerValue == 0) {
                stat = SFCEV_Charging_SystemConstantV2LCChargingPwrStat::ON;
        ...
        setSFCEV_Charging_SystemConstantV2LCChargingPwrStat(stat);
        setSFCEV_Charging_SystemConstantV2LCChargingPwrValue(value);
    }

    // 5.2.1.11.4 V2LC 충/방전 심볼
    void updateConstantV2LCFcevChargingStat() {
        SFCEV_Charging_SystemConstantV2LCFcevChargingStat stat = SFCEV_Charging_SystemConstantV2LCFcevChargingStat::OFF;
        if (mV2lcChargingInfoStatus == V2lcChargingInfoStatus::ON_CHARGING) {
            stat = SFCEV_Charging_SystemConstantV2LCFcevChargingStat::ON_CHARGING;
        }
        setSFCEV_Charging_SystemConstantV2LCFcevChargingStat(stat);
    }

    // 5.2.2 충전대기중 상세 표시
    // 5.2.2.1 충전 대기중 위젯 표시(Connect 플랫폼 Only)
    void updateConstantChargingWaitInfo() {
        SFCEV_Charging_SystemConstantChargingWaitInfoStat stat = SFCEV_Charging_SystemConstantChargingWaitInfoStat::DISPLAY_OFF;

        if (mEvChargeSchedWaitIndiStatus == EvChargeSchedWaitIndiStatus::ON) {
            stat = SFCEV_Charging_SystemConstantChargingWaitInfoStat::ON;
        }
        setSFCEV_Charging_SystemConstantChargingWaitInfoStat(stat);
    }

    // 5.2.2.1 요일 표시
    void updateConstantEvChargeSchedDay() {
        SFCEV_Charging_SystemConstantChargingSchedDayStat stat = SFCEV_Charging_SystemConstantChargingSchedDayStat::DISPLAY_OFF;

        switch (mEvChargeSchedDayStatus) {
            case EvChargeSchedDayStatus::SUN:
                stat = SFCEV_Charging_SystemConstantChargingSchedDayStat::SUN;
                break;
            case EvChargeSchedDayStatus::MON:
                stat = SFCEV_Charging_SystemConstantChargingSchedDayStat::MON;
                break;
            case EvChargeSchedDayStatus::TUE:
                stat = SFCEV_Charging_SystemConstantChargingSchedDayStat::TUE;
                break;
            case EvChargeSchedDayStatus::WED:
                stat = SFCEV_Charging_SystemConstantChargingSchedDayStat::WED;
                break;
            case EvChargeSchedDayStatus::THU:
                stat = SFCEV_Charging_SystemConstantChargingSchedDayStat::THU;
                break;
            case EvChargeSchedDayStatus::FRI:
                stat = SFCEV_Charging_SystemConstantChargingSchedDayStat::FRI;
                break;
            case EvChargeSchedDayStatus::SAT:
                stat = SFCEV_Charging_SystemConstantChargingSchedDayStat::SAT;
                break;
            default:
                break;
        }
        setSFCEV_Charging_SystemConstantChargingSchedDayStat(stat);
    }

    // 5.2.2.1 시간 표시(AM,PM,24 시간제)
    void updateConstantEvChargeSchedHour() {
        SFCEV_Charging_SystemConstantChargingSchedAMPMStat ampmStat =
            SFCEV_Charging_SystemConstantChargingSchedAMPMStat::DISPLAY_OFF;
        SFCEV_Charging_SystemConstantChargingSchedHourStat hourStat =
            SFCEV_Charging_SystemConstantChargingSchedHourStat::DISPLAY_OFF;
        HUInt64 hourValue = 0;

        if (mTimeDisplayInformationFromAvn != TimeDisplayInformationFromAvn::TWENTYFOUR) {
            if (mEvChargeSchedHourValue == kHourValue0) {
                ampmStat = SFCEV_Charging_SystemConstantChargingSchedAMPMStat::AM;
                hourStat = SFCEV_Charging_SystemConstantChargingSchedHourStat::VALUE;
                ...
                ampmStat = SFCEV_Charging_SystemConstantChargingSchedAMPMStat::PM;
                hourStat = SFCEV_Charging_SystemConstantChargingSchedHourStat::VALUE;
                hourValue = kHourValue12;
            ...
            if (mEvChargeSchedHourValue >= kHourValue0 && mEvChargeSchedHourValue <= kHourMaxValue23) {
                ampmStat = SFCEV_Charging_SystemConstantChargingSchedAMPMStat::DISPLAY_OFF;
                hourStat = SFCEV_Charging_SystemConstantChargingSchedHourStat::VALUE;
                hourValue = mEvChargeSchedHourValue;
            }
        }
        setSFCEV_Charging_SystemConstantChargingSchedAMPMStat(ampmStat);
        setSFCEV_Charging_SystemConstantChargingSchedHourStat(hourStat);
        setSFCEV_Charging_SystemConstantChargingSchedHourValue(hourValue);
    }

    // 5.2.2.1 분 표시
    void updateConstantEvChargeSchedMin() {
        SFCEV_Charging_SystemConstantChargingSchedMinStat stat = SFCEV_Charging_SystemConstantChargingSchedMinStat::DISPLAY_OFF;
        HUInt64 value = 0;

        if (mEvChargeSchedMinValue >= kMinMaxValue0 && mEvChargeSchedMinValue <= kMinMaxValue59) {
            stat = SFCEV_Charging_SystemConstantChargingSchedMinStat::VALUE;
            value = mEvChargeSchedMinValue;
        }

        setSFCEV_Charging_SystemConstantChargingSchedMinStat(stat);
        setSFCEV_Charging_SystemConstantChargingSchedMinValue(value);
    }

    // 5.2.3 충전 여부 판단
    void updateConstantChargingOnOffStat() {
        if (mEvChargeSchedWaitIndiStatus == EvChargeSchedWaitIndiStatus::OFF && mEvChargeStatus == EvChargeStatus::CHARGING) {
            setSFCEV_Charging_SystemConstantChargingOnOffStat(SFCEV_Charging_SystemConstantChargingOnOffStat::ON);
        } else {
            setSFCEV_Charging_SystemConstantChargingOnOffStat(SFCEV_Charging_SystemConstantChargingOnOffStat::OFF);
        }
    }

    // 5.2.1 충전,V2L,V2X,V2Lc 동작 상태(Connect 플랫폼 Only)
    // R037 사양 구현 시점 COMPLETE 발생 조건 없음. 향후 조건 발생 시 추가 예정(SFCDEV-38)
    void updateConstantChargingInfoForConnect() {
        SFCEV_Charging_SystemConstantChargingInfoForConnectStat stat =
            SFCEV_Charging_SystemConstantChargingInfoForConnectStat::OFF;
        ...
        if (mV2LDisplayOnFromVCMS == V2LDisplayOnFromVCMS::V2L_DISPLAY_ON &&
            ...
            stat = SFCEV_Charging_SystemConstantChargingInfoForConnectStat::V2X;
            ...
            stat = SFCEV_Charging_SystemConstantChargingInfoForConnectStat::V2L;
        } else if (mV2LCDisplayOnOffStatus == V2LCDisplayOnOffStatus::ON && mV2LCWarnStatus == V2LCWarnStatus::V2LC_START &&
                   mV2LCAlarmSubInfo == 3) {
            stat = SFCEV_Charging_SystemConstantChargingInfoForConnectStat::V2LC;
            ...
            stat = SFCEV_Charging_SystemConstantChargingInfoForConnectStat::CHARGING_EV;
        } else if (mConfigVehicleType == ConfigVehicleType::PHEV && mPrivateChargingStatus == ChargingStatus::CHARGING) {
            stat = SFCEV_Charging_SystemConstantChargingInfoForConnectStat::CHARGING_PHEV;
        } else {
            // no operation
        }
        setSFCEV_Charging_SystemConstantChargingInfoForConnectStat(stat);
    }
    ...
    void updateEventUnrechargeableShiftP() {
        if (mIsIgnOn == true && mEvShiftPToChargeReqStatus == EvShiftPToChargeReqStatus::ON &&
            ...
            setSFCEV_Charging_SystemEventEvShiftPToChargeReqStat(SFCEV_Charging_SystemEventEvShiftPToChargeReqStat::ON);
        } else {
            setSFCEV_Charging_SystemEventEvShiftPToChargeReqStat(SFCEV_Charging_SystemEventEvShiftPToChargeReqStat::OFF);
        }
    }
    ...
    void updateEventUnrechargeableObc() {
        ...
        GETCACHEDVALUE(SFC.EV_Charging_System.Event.EvChargeFailWarnObc.ID, prevEventID);
        if (prevEventID.empty() == false && prevEventID != eventID) {
            setSFCEV_Charging_SystemEventEvChargeFailWarnObcStat(SFCEV_Charging_SystemEventEvChargeFailWarnObcStat::OFF);
            flushLastGroup();
        }
        if (eventID.empty() == false) {
            setSFCEV_Charging_SystemEventEvChargeFailWarnObcID(eventID);
            setSFCEV_Charging_SystemEventEvChargeFailWarnObcStat(SFCEV_Charging_SystemEventEvChargeFailWarnObcStat::ON);
        }
    }
    ...
    void updateEventUnrechargeable() {
        ...
        std::string prevEventID;
        GETCACHEDVALUE(SFC.EV_Charging_System.Event.EvChargeFailWarn.ID, prevEventID);
        if (prevEventID.empty() == false && prevEventID != eventID) {
            setSFCEV_Charging_SystemEventEvChargeFailWarnStat(SFCEV_Charging_SystemEventEvChargeFailWarnStat::OFF);
            flushLastGroup();
        }
        if (eventID.empty() == false) {
            setSFCEV_Charging_SystemEventEvChargeFailWarnID(eventID);
            setSFCEV_Charging_SystemEventEvChargeFailWarnStat(SFCEV_Charging_SystemEventEvChargeFailWarnStat::ON);
        }
    }
    ...
    void updateEventChargeDoorOpen() {
            ...
            if (mEvChargerRear2ndDoorStatus == EvChargerRear2ndDoorStatus::OFF ||
                ...
                if (mEvChargeDoorFrontOpenStatus == EvChargeDoorFrontOpenStatus::OPEN ||
                    ...
                    if (mDisplaySpeedValueKPH < kDisplaySpeedValueKPH10) {
                        eventID = "E22107";
                        setSFCEV_Charging_SystemEventEvChargeDoorOpenLinkedSoundID("SND_PopUpInform2");
                        setSFCEV_Charging_SystemEventEvChargeDoorOpenLinkedSoundType(
                            SFCEV_Charging_SystemEventEvChargeDoorOpenLinkedSoundType::REPEAT_COUNT);
                        setSFCEV_Charging_SystemEventEvChargeDoorOpenLinkedSoundRepeatCount(1);
                    } else {
                        eventID = "E22108";
                        setSFCEV_Charging_SystemEventEvChargeDoorOpenLinkedSoundID("SND_PopUpWarn1");
                        setSFCEV_Charging_SystemEventEvChargeDoorOpenLinkedSoundType(
                            SFCEV_Charging_SystemEventEvChargeDoorOpenLinkedSoundType::DURATION);
                        setSFCEV_Charging_SystemEventEvChargeDoorOpenLinkedSoundDuration(kMaxEventDuration);
                    }
                }
            } else {
                if (mEvChargeDoorFrontOpenStatus == EvChargeDoorFrontOpenStatus::OPEN) {
        ...
        std::string prevEventID;
        GETCACHEDVALUE(SFC.EV_Charging_System.Event.EvChargeDoorOpen.ID, prevEventID);
        if (prevEventID.empty() == false && prevEventID != eventID) {
            setSFCEV_Charging_SystemEventEvChargeDoorOpenStat(SFCEV_Charging_SystemEventEvChargeDoorOpenStat::OFF);
            flushLastGroup();
        }
        if (eventID.empty() == false) {
            setSFCEV_Charging_SystemEventEvChargeDoorOpenID(eventID);
            setSFCEV_Charging_SystemEventEvChargeDoorOpenStat(SFCEV_Charging_SystemEventEvChargeDoorOpenStat::ON);
        }
    }
    ...
    void updateEventChargeDoorOpenMalfunction() {
        ...
        if (mIsIgnOn == true) {
            if (mEvChargeDoorMalfunctionStatus == EvChargeDoorMalfunctionStatus::FAILURE ||
                ...
                setSFCEV_Charging_SystemEventEvChargeDoorMalfunctionStat(
                    SFCEV_Charging_SystemEventEvChargeDoorMalfunctionStat::ON);
                eventID = "E22109";
        ...
        GETCACHEDVALUE(SFC.EV_Charging_System.Event.EvChargeDoorMalfunction.ID, prevEventID);
        if (prevEventID.empty() == false && prevEventID != eventID) {
            setSFCEV_Charging_SystemEventEvChargeDoorMalfunctionStat(SFCEV_Charging_SystemEventEvChargeDoorMalfunctionStat::OFF);
            flushLastGroup();
        }
        if (eventID.empty() == false) {
            setSFCEV_Charging_SystemEventEvChargeDoorMalfunctionID(eventID);
            setSFCEV_Charging_SystemEventEvChargeDoorMalfunctionStat(SFCEV_Charging_SystemEventEvChargeDoorMalfunctionStat::ON);
        }
    }
    ...
    void updateEventChargingWaiting() {
        if (mEvChargeSchedWaitIndiStatus == EvChargeSchedWaitIndiStatus::ON) {
            setSFCEV_Charging_SystemEventEvChargeSchedWaitStat(SFCEV_Charging_SystemEventEvChargeSchedWaitStat::ON);
        } else {
            setSFCEV_Charging_SystemEventEvChargeSchedWaitStat(SFCEV_Charging_SystemEventEvChargeSchedWaitStat::OFF);
        }
    }
    ...
    void updateEventCharging() {
        ...
        std::string prevEventID;
        GETCACHEDVALUE(SFC.EV_Charging_System.Event.EvCharge.ID, prevEventID);
        if (prevEventID.empty() == false && prevEventID != eventID) {
            setSFCEV_Charging_SystemEventEvChargeStat(SFCEV_Charging_SystemEventEvChargeStat::OFF);
            flushLastGroup();
        }
        if (eventID.empty() == false) {
            setSFCEV_Charging_SystemEventEvChargeID(eventID);
            setSFCEV_Charging_SystemEventEvChargeStat(SFCEV_Charging_SystemEventEvChargeStat::ON);
        }
    }
    ...
    void updateEventChargingV2L() {
        ...
        std::string prevEventID;
        GETCACHEDVALUE(SFC.EV_Charging_System.Event.EvFastChargeFailWarn.ID, prevEventID);
        if (prevEventID.empty() == false && prevEventID != eventID) {
            setSFCEV_Charging_SystemEventEvFastChargeFailWarnStat(SFCEV_Charging_SystemEventEvFastChargeFailWarnStat::OFF);
            flushLastGroup();
        }
        if (eventID.empty() == false) {
            setSFCEV_Charging_SystemEventEvFastChargeFailWarnID(eventID);
            setSFCEV_Charging_SystemEventEvFastChargeFailWarnStat(SFCEV_Charging_SystemEventEvFastChargeFailWarnStat::ON);
        }
    }
    ...
    void updateEventChgCalcErrorStatus() {
        ...
        std::string prevEventID;
        GETCACHEDVALUE(SFC.EV_Charging_System.Event.EvChgCalculateError.ID, prevEventID);
        if (prevEventID.empty() == false && prevEventID != eventID) {
            setSFCEV_Charging_SystemEventEvChgCalculateErrorStat(SFCEV_Charging_SystemEventEvChgCalculateErrorStat::OFF);
            flushLastGroup();
        }
        if (eventID.empty() == false) {
            setSFCEV_Charging_SystemEventEvChgCalculateErrorID(eventID);
            setSFCEV_Charging_SystemEventEvChgCalculateErrorStat(SFCEV_Charging_SystemEventEvChgCalculateErrorStat::ON);
        }
    }
    ...
    void updateEventEvUnreliableSocWarn() {
        ...
        std::string prevEventID;
        GETCACHEDVALUE(SFC.EV_Charging_System.Event.EvUnreliableSocWarn.ID, prevEventID);
        if (prevEventID.empty() == false && prevEventID != eventID) {
            setSFCEV_Charging_SystemEventEvUnreliableSocWarnStat(SFCEV_Charging_SystemEventEvUnreliableSocWarnStat::OFF);
            flushLastGroup();
        }
        if (eventID.empty() == false) {
            setSFCEV_Charging_SystemEventEvUnreliableSocWarnID(eventID);
            setSFCEV_Charging_SystemEventEvUnreliableSocWarnStat(SFCEV_Charging_SystemEventEvUnreliableSocWarnStat::ON);
        }
    }
    ...
    void updateEventV2LCInoperableAndRunning() {
        ...
        std::string prevEventID;
        GETCACHEDVALUE(SFC.EV_Charging_System.Event.V2LCInoperableAndRunning.ID, prevEventID);
        if (prevEventID.empty() == false && prevEventID != eventID) {
            setSFCEV_Charging_SystemEventV2LCInoperableAndRunningStat(
                SFCEV_Charging_SystemEventV2LCInoperableAndRunningStat::OFF);
            flushLastGroup();
        }
        if (eventID.empty() == false) {
            setSFCEV_Charging_SystemEventV2LCInoperableAndRunningID(eventID);
            setSFCEV_Charging_SystemEventV2LCInoperableAndRunningStat(SFCEV_Charging_SystemEventV2LCInoperableAndRunningStat::ON);
            setSFCEV_Charging_SystemEventV2LCInoperableAndRunningLinkedSoundID(soundID);
        }
    }
    ...
    void updateEventV2LOnlyDoorOpen() {
        std::string eventID;
        std::string soundID;
        SFCEV_Charging_SystemEventV2LOnlyDoorOpenLinkedSoundType soundType =
            SFCEV_Charging_SystemEventV2LOnlyDoorOpenLinkedSoundType::NONE;
        if (mIsIgnOn == true && mV2LOnlyDoorOpenStatus == V2LOnlyDoorOpenStatus::OPEN &&
            mVehicleReadyStatus == VehicleReadyStatus::READY) {
            if (mDisplaySpeedValueKPH < kDisplaySpeedValueKPH10) {
                eventID = "E22129";
                soundID = "SND_PopUpInform2";
                soundType = SFCEV_Charging_SystemEventV2LOnlyDoorOpenLinkedSoundType::REPEAT_COUNT;
                setSFCEV_Charging_SystemEventV2LOnlyDoorOpenLinkedSoundRepeatCount(1);
            } else {
                eventID = "E22130";
                soundID = "SND_PopUpWarn1";
                soundType = SFCEV_Charging_SystemEventV2LOnlyDoorOpenLinkedSoundType::DURATION;
                setSFCEV_Charging_SystemEventV2LOnlyDoorOpenLinkedSoundDuration(kMaxEventDuration);
            }
        }

        std::string prevEventID;
        GETCACHEDVALUE(SFC.EV_Charging_System.Event.V2LOnlyDoorOpen.ID, prevEventID);
        if (prevEventID.empty() == false && prevEventID != eventID) {
            setSFCEV_Charging_SystemEventV2LOnlyDoorOpenStat(SFCEV_Charging_SystemEventV2LOnlyDoorOpenStat::OFF);
            flushLastGroup();
        }
        if (eventID.empty() == false) {
            setSFCEV_Charging_SystemEventV2LOnlyDoorOpenID(eventID);
            setSFCEV_Charging_SystemEventV2LOnlyDoorOpenStat(SFCEV_Charging_SystemEventV2LOnlyDoorOpenStat::ON);
            setSFCEV_Charging_SystemEventV2LOnlyDoorOpenLinkedSoundID(soundID);
            setSFCEV_Charging_SystemEventV2LOnlyDoorOpenLinkedSoundType(soundType);
        }
    }

    // 5.3.8 V2LC 실행 중 변속 불가
    void updateEventV2LCTailgate() {
        SFCEV_Charging_SystemEventV2LCTailgateStat stat = SFCEV_Charging_SystemEventV2LCTailgateStat::OFF;
        if (mIsIgnOn == true && mSbwWarnStatusFromSCU == SbwWarnStatusFromSCU::V2LC_TAILGATE) {
            stat = SFCEV_Charging_SystemEventV2LCTailgateStat::ON;
        }
        setSFCEV_Charging_SystemEventV2LCTailgateStat(stat);
    }
    ...
    using TimeDisplayInformationFromAvn = ArgumentsEvChargeSchedHourChanged::Input_TimeDisplayInformationFromAvn;
    ...
    using V2lcChargingInfoStatus = ArgumentsV2LCChargingInfoStatusChanged::Input_V2lcChargingInfoStatus;
    ...
    TimeDisplayInformationFromAvn mTimeDisplayInformationFromAvn = TimeDisplayInformationFromAvn::OFF;
    ...
    HUInt64 mV2LCMinimumSocValue = 0;
    ...
    SFCEV_Charging_SystemConstantCharging80SocTimeStat mSFCEV_Charging_SystemConstantCharging80SocTimeStat =
        SFCEV_Charging_SystemConstantCharging80SocTimeStat::DISPLAY_OFF;
    ...
    V2lcChargingInfoStatus mV2lcChargingInfoStatus = V2lcChargingInfoStatus::OFF;
    ...
    ssfs::SFCTimer<EV_Charging_System> mOneShotTimerPrivateChargingStatus;
};

}  // namespace ccos

#endif  // SFSS_EV_Charging_System_H
