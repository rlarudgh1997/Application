 ...
 */
#ifndef SFSS_Illumination_CV_H
#define SFSS_Illumination_CV_H

#define DLOG_ENABLED gEnableSFCLog

#include "Illumination_CVBase.hpp"
#include <array>
#include <cstring>
#include <SFCTimer.h>
#include <Vehicle.h>
...
// SFC Version : 2.0.0
// Spec Version : v0.23
// Reference : [CV070] Illumination_CV. Contains : Constant, Event. Recommend: VALUE_CHANGED
class Illumination_CV : public Illumination_CVBase {
public:
    Illumination_CV() = default;
    ~Illumination_CV() override = default;
    Illumination_CV(const Illumination_CV& other) = delete;
    Illumination_CV(Illumination_CV&& other) noexcept = delete;
    Illumination_CV& operator=(const Illumination_CV& other) = delete;
    Illumination_CV& operator=(Illumination_CV&& other) noexcept = delete;

    void onInitialize() override {
        if (mRepeatTimerTransitionLogStyleDialTimerEvery100ms.create(
                kTimerTransitionInterval100ms, this, &Illumination_CV::onRepeatTimerTransitionLogStyleDialTimerEvery100msChanged,
                true) == false) {
            DWarning() << "[Illumination_CV] mRepeatTimerTransitionLogStyleDialTimerEvery100ms Create Failed";
        }

        if (mRepeatTimerTransitionExpStyleDialTimerEvery100ms.create(
                kTimerTransitionInterval100ms, this, &Illumination_CV::onRepeatTimerTransitionExpStyleDialTimerEvery100msChanged,
                true) == false) {
            DWarning() << "[Illumination_CV] mRepeatTimerTransitionExpStyleDialTimerEvery100ms Create Failed";
        }

        if (mRepeatTimerTransitionLogStylePointerTimerEvery100ms.create(
                kTimerTransitionInterval100ms, this,
                &Illumination_CV::onRepeatTimerTransitionLogStylePointerTimerEvery100msChanged, true) == false) {
            DWarning() << "[Illumination_CV] mRepeatTimerTransitionLogStylePointerTimerEvery100ms Create Failed";
        }

        if (mRepeatTimerTransitionExpStylePointerTimerEvery100ms.create(
                kTimerTransitionInterval100ms, this,
                &Illumination_CV::onRepeatTimerTransitionExpStylePointerTimerEvery100msChanged, true) == false) {
            DWarning() << "[Illumination_CV] mRepeatTimerTransitionExpStylePointerTimerEvery100ms Create Failed";
        }

        if (mOneShotTimerIgnElapsedOn400ms.create(kTimerIgnElapsedOnInterval400ms, this,
                                                  &Illumination_CV::onOneShotTimerIgnElapsedOn400msChanged, false) == false) {
            DWarning() << "[Illumination_CV] mOneShotTimerIgnElapsedOn400ms Create Failed";
        }

        if (mOneShotTimerPrivate_DialLightingStatusTurningOn2000ms.create(
                kTimerPrivateDialLightingTurnOnInterval2s, this,
                &Illumination_CV::onOneShotTimerPrivate_DialLightingStatusTurningOn2000msChanged, false) == false) {
            DWarning() << "[Illumination_CV] mOneShotTimerPrivate_DialLightingStatusTurningOn2000ms Create Failed";
        }

        if (mOneShotTimerPrivate_DialLightingStatusTurningOff2000ms.create(
                kTimerPrivateDialLightingTurnOffInterval2s, this,
                &Illumination_CV::onOneShotTimerPrivate_DialLightingStatusTurningOff2000msChanged, false) == false) {
            DWarning() << "[Illumination_CV] mOneShotTimerPrivate_DialLightingStatusTurningOff2000ms Create Failed";
        }

        if (mOneShotTimerPrivate_RheostatSwitchOperation500ms.create(
                kTimerPrivateRheostatSwitchOperationInterval500ms, this,
                &Illumination_CV::onOneShotTimerPrivate_RheostatSwitchOperation500msChanged, false) == false) {
            DWarning() << "[Illumination_CV] mOneShotTimerPrivate_RheostatSwitchOperation500ms Create Failed";
        }

        if (mOneShotTimerWaitAvnAutoBrightValueChanged100ms.create(
                kTimerWaitAvnAutoBrightValueChanged100ms, this,
                &Illumination_CV::onOneShotTimerWaitAvnAutoBrightValueChanged100msChanged, false) == false) {
            DWarning() << "[Illumination_CV] mOneShotTimerWaitAvnAutoBrightValueChanged100ms Create Failed";
        }

        if (mOneShotTimerBlinkPrivate_RheostatSwitchOperation.create(
                kTimerPrivateRheostatSwitchOperationInterval500ms, this,
                &Illumination_CV::onOneShotTimerPrivate_RheostatSwitchOperationBlink, false) == false) {
            DWarning() << "[Illumination_CV] mOneShotTimerBlinkPrivate_RheostatSwitchOperation Create Failed";
        }

        if (mOneShotTimerInter_EventInfoDisplayStatusOff5000ms.create(
                kTimerEventInfoDisplayStatusOffInterval5s, this,
                &Illumination_CV::onOneShotTimerInter_EventInfoDisplayStatusOff5000msTimeout, false) == false) {
            DWarning() << "[Illumination_CV] mOneShotTimerInter_EventInfoDisplayStatusOff5000ms Create Failed";
        }

        if (mOneShotTimerPrivate_IgOffDisplayOnStatusOff5000ms.create(
                kTimerPrivateIgOffDisplayOnStatusOffInterval5s, this,
                &Illumination_CV::onOneShotTimerPrivate_IgOffDisplayOnStatusOff5000msTimeout, false) == false) {
            DWarning() << "[Illumination_CV] mOneShotTimerPrivate_IgOffDisplayOnStatusOff5000ms Create Failed";
        }

        setSFCIllumination_CVEventRheostatFeedbackNoAVNID("E00501");
        setSFCIllumination_CVEventRheostatFeedbackNoAVNLinkedSoundID("SND_PopUpInform1");
        setSFCIllumination_CVEventRheostatFeedbackNoAVNLinkedSoundRepeatCount(1);
        setSFCIllumination_CVEventRheostatFeedbackNoAVNStat(SFCIllumination_CVEventRheostatFeedbackNoAVNStat::OFF);

        setSFCIllumination_CVEventRheostatFeedbackAvnLinkID("E00502");
        setSFCIllumination_CVEventRheostatFeedbackAvnLinkLinkedSoundID("SND_PopUpInform1");
        setSFCIllumination_CVEventRheostatFeedbackAvnLinkLinkedSoundRepeatCount(1);
        setSFCIllumination_CVEventRheostatFeedbackAvnLinkStat(SFCIllumination_CVEventRheostatFeedbackAvnLinkStat::OFF);
    }
    ...
    void onIgnElapseOn0msChanged(const ArgumentsIgnElapseOn0msChanged& /*args*/) {
        ...
        if (mOneShotTimerIgnElapsedOn400ms.restart() == false) {
            DWarning() << "[Illumination_CV] mOneShotTimerIgnElapsedOn400ms Restart Failed";
        }
        ...
        updateConstantClusterDimmingModeStat();
    }
    ...
    void onRheostatSwitchChanged(const ArgumentsRheostatSwitchChanged& args) {
        ...
        updateConstantClusterDimmingModeStat(EPrivate_InterRheostatLevelUpdateReason::INTER_RHEO_STAT_SWITCH_STATUS_CHANGED);
    ...
    void onDayAndNightModeChanged(const ArgumentsDayAndNightModeChanged& args) {
        mInteriorLampOnReqStatus = args.mInput_InteriorLampOnReqStatus;
        mAvTailLampStatus = args.mInput_AvTailLampStatus;
        mAutolightSensorNightStatus = args.mInput_AutolightSensorNightStatus;

        DDebug() << "Illu_SFC : onDayAndNightModeChanged - mInteriorLampOnReqStatus: "
                 << static_cast<uint64_t>(mInteriorLampOnReqStatus);
    ...
    void onEventInfoDisplayStatusChanged(const ArgumentsEventInfoDisplayStatusChanged& args) {
        ...
        if (mEventInfoDisplayStatus == EventInfoDisplayStatus::OFF) {
            if (mOneShotTimerInter_EventInfoDisplayStatusOff5000ms.start() == false) {
                DWarning() << "[Illumination_CV] mOneShotTimerInter_EventInfoDisplayStatusOff5000ms Start Failed";
            }
        } else {
    ...
    void onIgOffDisplayOnStatusChanged(const ArgumentsIgOffDisplayOnStatusChanged& args) {
        ...
        if (mIgOffDisplayOnStatus == IgOffDisplayOnStatus::OFF) {
            if (mOneShotTimerPrivate_IgOffDisplayOnStatusOff5000ms.start() == false) {
                DWarning() << "[Illumination_CV] mOneShotTimerPrivate_IgOffDisplayOnStatusOff5000ms Start Failed";
            }
        } else {
    ...
    void onRheostatLevelStatusChanged(const ArgumentsRheostatLevelStatusChanged& args) {
        ...
        if (updateValueIfValid(mMemory_RheostatLevelStatus, args.mInter_RheostatLevelStatus) == true) {
            if (mAEMInitializeComplete == true) {
                ...
                setSFCIllumination_CVConstantRheostatLevelStat(mInter_RheostatLevelStatus);
    ...
    void onParamDimmingRateValueChanged(const ArgumentsParamDimmingRateValueChanged& args) {
        if (updateValueIfValid(mPar_DimmingRateValue, args.mPar_DimmingRateValue) == true) {
            DDebug() << "mPar_DimmingRateValue set";
        }
        updateConstantClusterDimmingModeStat();
    }
...
private:
    ...
    void updateInterIllCluster() {
        ...
        if ((mConfigAutolight == ConfigAutolight::OFF && mInteriorLampOnReqStatus == InteriorLampOnReqStatus::OFF) ||
            ...
            mInter_IllCluster = SFCIllumination_CVInter_IllCluster::DAY;
            ...
            mInter_IllCluster = SFCIllumination_CVInter_IllCluster::DUSK;
        } else {
            mInter_IllCluster = SFCIllumination_CVInter_IllCluster::NIGHT;
        }

        DDebug() << "Illu_SFC : updateInterIllCluster - mConfigAutolight : " << static_cast<uint64_t>(mConfigAutolight);
        DDebug() << "Illu_SFC : updateInterIllCluster - mInteriorLampOnReqStatus : "
                 << static_cast<uint64_t>(mInteriorLampOnReqStatus);
        ...
        setSFCIllumination_CVInter_IllCluster(mInter_IllCluster);

        // updateInterClusterLightingLevel 함수 내에 아래 항목 포함됨
        // updateOutDetentStatus();
        // updateOutIllumination_CVLevelValue();
    ...
    void updateInterMinLightMode() {
        if ((mIgnElapsed == IgnElapsed::ON_0ms || mIgnElapsed == IgnElapsed::ON_400ms) &&
            ...
            mInter_MinLightMode = SFCIllumination_CVInter_MinLightMode::ON;
        } else {
            mInter_MinLightMode = SFCIllumination_CVInter_MinLightMode::OFF;
        }
        setSFCIllumination_CVInter_MinLightMode(mInter_MinLightMode);
    ...
    void updateIllumLoadCalLogic() {
        // 4.4.2.1.4 조명 단계 저장 및 불러오기 -> 불러오기
        // B+ on after 500ms
    ...
    void updateLcdDuty() {
        // 4.5.3.3 조명 동작 상태별 조명 제어 Inter_IllumLcdDuty
        if (mAEMInitializeComplete == true) {
            HDouble lcdDuty = 0.;
            ...
            if (mEPrivate_LcdLightingStatus == EPrivate_LcdLightingStatus::ON &&
                ...
                if (mInter_MinLightMode == SFCIllumination_CVInter_MinLightMode::OFF) {
                    lcdDuty = mPrivate_DayLcdDutySetValue;
                    DDebug() << "Illu_SFC : updateLcdDuty - ConfigAvnBrightLink::ON, EPrivate_NaviMapStatus::DAY, "
                             << "EPrivate_LcdLightingStatus::ON, Inter_MinLightMode::SFCIllumination_CVInter_MinLightMode::OFF";
                } else if (mInter_MinLightMode == SFCIllumination_CVInter_MinLightMode::ON) {
                    // Par_IllumDayLCD[1]
                    lcdDuty = getUInt16ValueFromArrayAsHDoubleWithDiv100(mIllumDayLcdParamDataArray, kParamArrayIndexFirst);
                    DDebug() << "Illu_SFC : updateLcdDuty - ConfigAvnBrightLink::ON, EPrivate_NaviMapStatus::DAY, "
                             << "EPrivate_LcdLightingStatus::ON, Inter_MinLightMode::SFCIllumination_CVInter_MinLightMode::ON";
                } else {
                    // no operation
                }
            } else if (mEPrivate_LcdLightingStatus == EPrivate_LcdLightingStatus::ON &&
                ...
                if (mInter_MinLightMode == SFCIllumination_CVInter_MinLightMode::OFF) {
                    ...
                    DDebug() << "Illu_SFC : updateLcdDuty - ConfigAvnBrightLink::ON, EPrivate_NaviMapStatus::NIGHT, "
                             << "EPrivate_LcdLightingStatus::ON, mInter_MinLightMode::SFCIllumination_CVInter_MinLightMode::ON";
                } else {
                    // no operation
                }
            ...
            if (almostEqual(lcdDuty, static_cast<HDouble>(UINT16_MAX)) == false) {
                ...
                if (mIgnElapsed == IgnElapsed::OFF_0ms && mIgOffDisplayOnStatus != IgOffDisplayOnStatus::NONE) {
                    setSFCIllumination_CVInter_IllumLcdDuty(lcdDuty);
    ...
    void requestSetDialDuty(HDouble targetDialValue,
        ...
        if (mTransitionDialStatus == true) {
            ...
            if (controlTransitionType == EPrivate_LightingTransitionType::NONE ||
                ...
                setSFCIllumination_CVInter_IllumDialDuty(targetDialValue);
                return;
            }

            GETCACHEDVALUE(SFC.Illumination_CV.Inter_IllumDialDuty, mTransitionDialStartValue);
            ...
            if (controlTransitionType == EPrivate_LightingTransitionType::LOG_STYLE_TRANSITION) {
                ...
                if (mRepeatTimerTransitionLogStyleDialTimerEvery100ms.start() == false) {
                    DWarning() << "[Illumination_CV] mRepeatTimerTransitionLogStyleDialTimerEvery100ms Start Failed";
                }
                ...
                if (mRepeatTimerTransitionExpStyleDialTimerEvery100ms.start() == false) {
                    DWarning() << "[Illumination_CV] mRepeatTimerTransitionExpStyleDialTimerEvery100ms Start Failed";
                }
            } else {
                // maintain the status
            }
    ...
    void transitionLogDialFunction() {
        ...
        setSFCIllumination_CVInter_IllumDialDuty(dialValue);
        doFlush();
    }
    ...
    void requestSetPointerDuty(HDouble targetPointerValue,
        ...
        if (mTransitionPointerStatus == true) {
            ...
            if (controlTransitionType == EPrivate_LightingTransitionType::NONE ||
                ...
                setSFCIllumination_CVInter_IllumPointerDuty(targetPointerValue);
                return;
            }

            GETCACHEDVALUE(SFC.Illumination_CV.Inter_IllumPointerDuty, mTransitionPointerStartValue);
            ...
            if (controlTransitionType == EPrivate_LightingTransitionType::LOG_STYLE_TRANSITION) {
                ...
                if (mRepeatTimerTransitionLogStylePointerTimerEvery100ms.start() == false) {
                    DWarning() << "[Illumination_CV] mRepeatTimerTransitionLogStylePointerTimerEvery100ms Start Failed";
                }
            } else if (controlTransitionType == EPrivate_LightingTransitionType::EXPONENTIAL_STYLE_TRANSITION) {
                mTransitionPointerStatus = true;
                if (mRepeatTimerTransitionExpStylePointerTimerEvery100ms.start() == false) {
                    DWarning() << "[Illumination_CV] mRepeatTimerTransitionExpStylePointerTimerEvery100ms Start Failed";
                }
            } else {
                // maintain the status
            }
    ...
    void transitionLogPointerFunction() {
        ...
        setSFCIllumination_CVInter_IllumPointerDuty(pointerValue);
        doFlush();
    }
    ...
    void updateGreenWhiteDuty() {
        ...
        if (mAEMInitializeComplete == true) {
            ...
            if (almostEqual(greenDuty, static_cast<HDouble>(UINT16_MAX)) == false) {
                ...
                setSFCIllumination_CVInter_IllumSymbolGreenDuty(greenDuty);
            }
            if (almostEqual(whiteDuty, static_cast<HDouble>(UINT16_MAX)) == false) {
                DDebug() << "set whiteDuty : " << whiteDuty;
                setSFCIllumination_CVInter_IllumSymbolWhiteDuty(whiteDuty);
            }
        }
    }
    ...
    void updateOutRheostatLevelStat() {
        ...
        outputAddressList.emplace_back(Vehicle.CV.Illumination_CV.Output_RheostatLevelStatus,
    ...
    void updateOutIllumDutyValue() {
        ...
        if (mAEMInitializeComplete == true) {
            ...
            if (mPrivate_LightOutLevel <= 2 || mInter_MinLightMode == SFCIllumination_CVInter_MinLightMode::ON) {
                dutyValue = 3.00;
            } else if (mInter_MinLightMode == SFCIllumination_CVInter_MinLightMode::OFF) {
    ...
    void updateOutRheostatMaxInfo() {
        // 4.7 조명 조절 USM 생성 제어
        AddressValueList outputAddressList;
        decltype(Vehicle.CV.Illumination_CV.Output_RheostatMaxInfo)::TYPE output_RheostatMaxInfoType =
            decltype(Vehicle.CV.Illumination_CV.Output_RheostatMaxInfo)::TYPE::INVALID;
        if (mConfigAvnBrightLink == ConfigAvnBrightLink::OFF) {
            if (mConfigAutolight == ConfigAutolight::ON) {
                output_RheostatMaxInfoType = decltype(Vehicle.CV.Illumination_CV.Output_RheostatMaxInfo)::TYPE::STEP20;
            } else if (mConfigAutolight == ConfigAutolight::OFF) {
                output_RheostatMaxInfoType = decltype(Vehicle.CV.Illumination_CV.Output_RheostatMaxInfo)::TYPE::STEP21;
            } else {
                // no operation
            }
        } else if (mConfigAvnBrightLink == ConfigAvnBrightLink::ON) {
            output_RheostatMaxInfoType = decltype(Vehicle.CV.Illumination_CV.Output_RheostatMaxInfo)::TYPE::INVALID;
        } else {
            // no operation
        }

        outputAddressList.emplace_back(Vehicle.CV.Illumination_CV.Output_RheostatMaxInfo,
    ...
    void updateOutDetentStatus() {
        ...
        decltype(Vehicle.CV.Illumination_CV.Output_DetentStatus)::TYPE output_IllumDetentStatusType =
            decltype(Vehicle.CV.Illumination_CV.Output_DetentStatus)::TYPE::OFF;
        if (mInter_MinLightMode == SFCIllumination_CVInter_MinLightMode::OFF &&
            (mInter_IllCluster == SFCIllumination_CVInter_IllCluster::DAY || mInter_ClusterLightingLevel == 1000)) {
            output_HardWireDetentStatusType = decltype(Vehicle.System.HardWire.Output_DetentStatus)::TYPE::ON;
            output_IllumDetentStatusType = decltype(Vehicle.CV.Illumination_CV.Output_DetentStatus)::TYPE::ON;
        } else if (mInter_MinLightMode != SFCIllumination_CVInter_MinLightMode::OFF ||
                   (mInter_IllCluster != SFCIllumination_CVInter_IllCluster::DAY && mInter_ClusterLightingLevel != 1000)) {
            output_HardWireDetentStatusType = decltype(Vehicle.System.HardWire.Output_DetentStatus)::TYPE::OFF;
            output_IllumDetentStatusType = decltype(Vehicle.CV.Illumination_CV.Output_DetentStatus)::TYPE::OFF;
        } else {
            // no operation
        }
        ...
        outputAddressList.emplace_back(Vehicle.CV.Illumination_CV.Output_DetentStatus,
                                       static_cast<HUInt64>(output_IllumDetentStatusType));
        setValue(outputAddressList);
        outputAddressList.clear();
    }

    void updateOutIllumination_CVLevelValue() {
        AddressValueList outputAddressList;
        HUInt64 lvlVal = 0;
        if (mInter_MinLightMode == SFCIllumination_CVInter_MinLightMode::OFF) {
        ...
        outputAddressList.emplace_back(Vehicle.CV.Illumination_CV.Output_IlluminationLevelValue, static_cast<HUInt64>(lvlVal));
        setValue(outputAddressList);
        outputAddressList.clear();
    }

    void updateOutNotMinIllumination_CVLevelValue() {
        AddressValueList outputAddressList;
        outputAddressList.emplace_back(Vehicle.CV.Illumination_CV.Output_NotMinIlluminationLevelValue,
    ...
    void updateInterClusterLightingLevel() {
        ...
        setSFCIllumination_CVInter_ClusterLightingLevel(mInter_ClusterLightingLevel);
        ...
        setSFCIllumination_CVConstantClusterLightingLevelStatValue(mIMG_ClusterLightingLevel_Stat);
        ...
        updateOutDetentStatus();
        updateOutIllumination_CVLevelValue();
        updateOutNotMinIllumination_CVLevelValue();
        updateOutIllumDutyValue();
        updatePointerAndDialDuty();
        updateGreenWhiteDuty();
        updateLcdDuty();
    ...
    void updatePrivate_LcdLightingStatus() {
        ...
        if (mIgnElapsed == IgnElapsed::ON_400ms) {
            ...
            // 4.5..3.1 테이블에서 Private_IgOffDisplay 값 계산은 App에서 수행하고
            // 그 값을 SFC.Extension.Illumination_CV.Inter_IgOffDisplayOnStatus로 받는다.
    ...
    void updatePrivate_RheostatSwitchOperation() {
        ...
        if (mRheostatSwitch == RheostatSwitch::UP) {
            ...
            if (mRheostatSwitchPrevious == RheostatSwitch::DEFAULT) {
                mEPrivate_RheostatSwitchOperation = EPrivate_RheostatSwitchOperation::DOWN;
                requestSet500msPrivate_RheostatSwitchOperationTimer();
                requestWaitAvnBrightValueChangedDown100msTimer();
    ...
    uint32_t updatePrivate_RheostatSwitchOperationBlink() {
        // 4.4.2.1.2 스위치 동작 이벤트 정의 - periodic
        mEPrivate_RheostatSwitchOperationPrevious = mEPrivate_RheostatSwitchOperation;
    ...
    // 5.1.5.2.3 배경이미지 구분을 위한 주야간 판단
    void updateConstantDayNightStat() {
        SFCIllumination_CVConstantDayNightStat stat = SFCIllumination_CVConstantDayNightStat::NONE;

        if (mConfigAvnBrightLink == ConfigAvnBrightLink::ON) {
            if (mEPrivate_NaviMapStatus == EPrivate_NaviMapStatus::DAY) {
                stat = SFCIllumination_CVConstantDayNightStat::DAY;
            } else if (mEPrivate_NaviMapStatus == EPrivate_NaviMapStatus::NIGHT) {
                stat = SFCIllumination_CVConstantDayNightStat::NIGHT;
            } else {
                // nothing
            }
        } else if (mConfigAvnBrightLink == ConfigAvnBrightLink::OFF) {
            if (mInter_IllCluster == SFCIllumination_CVInter_IllCluster::DAY ||
                mInter_IllCluster == SFCIllumination_CVInter_IllCluster::DUSK) {
                stat = SFCIllumination_CVConstantDayNightStat::DAY;
            } else if (mInter_IllCluster == SFCIllumination_CVInter_IllCluster::NIGHT) {
                stat = SFCIllumination_CVConstantDayNightStat::NIGHT;
        ...
        setSFCIllumination_CVConstantDayNightStat(stat);
    }

    // 5.1.5.2.4 Dimming Mode
    void updateConstantClusterDimmingModeStat(
        const EPrivate_InterRheostatLevelUpdateReason& updateReason = EPrivate_InterRheostatLevelUpdateReason::NONE) {
        if (mAEMInitializeComplete == true) {
            HUInt64 value = 0;
            if (mIgnElapsed == IgnElapsed::ON_0ms || mIgnElapsed == IgnElapsed::ON_400ms) {
                if (updateReason == EPrivate_InterRheostatLevelUpdateReason::INTER_RHEO_STAT_SWITCH_STATUS_CHANGED) {
                    if (mInter_RheostatLevelStatus == kRheostatLevelStep1 &&
                        (mRheostatSwitchPrevious == RheostatSwitch::DEFAULT && mRheostatSwitch == RheostatSwitch::DOWN)) {
                        // 레오스탯 하드 스위치 DOWN 버튼을 누를 경우 사양 동작 (실제 DOWN 버튼 Press 동작시)
                        value = mPar_DimmingRateValue;
                    } else if (mInter_RheostatLevelStatus == kRheostatLevelStep1 &&
                               (mRheostatSwitchPrevious == RheostatSwitch::DOWN && mRheostatSwitch == RheostatSwitch::DEFAULT)) {
                        // 레오스탯 하드 스위치 DOWN 버튼이 눌린 Press 상태에서, 손을 떼는 경우 (실제 DOWN 버튼 Release 동작시)
                        return;
                    } else {
                        // no operation
                    }
            ...
            setSFCIllumination_CVConstantClusterDimmingModeValue(value);
        }
    }
    ...
    void requestSetTurnOn2000msPrivate_DialLightingStatusTimer() {
        ...
        if (mOneShotTimerPrivate_DialLightingStatusTurningOn2000ms.start() == false) {
            DWarning() << "[Illumination_CV] mOneShotTimerPrivate_DialLightingStatusTurningOn2000ms Start Failed";
        }
    }
    ...
    void requestSetTurnOff2000msPrivate_DialLightingStatusTimer() {
        ...
        if (mOneShotTimerPrivate_DialLightingStatusTurningOff2000ms.start() == false) {
            DWarning() << "[Illumination_CV] mOneShotTimerPrivate_DialLightingStatusTurningOff2000ms Start Failed";
        }
    }
    ...
    void requestSet500msPrivate_RheostatSwitchOperationTimer() {
        ...
        if (mOneShotTimerPrivate_RheostatSwitchOperation500ms.start() == false) {
            DWarning() << "[Illumination_CV] mOneShotTimerPrivate_RheostatSwitchOperation500ms Start Failed";
        }
    }
    ...
    void requestBlinkPrivate_RheostatSwitchOperationTimer(const uint32_t& myTimeout) {
        ...
        if (mOneShotTimerBlinkPrivate_RheostatSwitchOperation.start() == false) {
            DWarning() << "[Illumination_CV] mOneShotTimerBlinkPrivate_RheostatSwitchOperation Start Failed";
        }
    }
    ...
    void requestWaitAvnBrightValueChangedUp100msTimer() {
        mWait_AvnBrightValueChagedUp = true;
        mOneShotTimerWaitAvnAutoBrightValueChanged100ms.start();
    }

    void requestWaitAvnBrightValueChangedDown100msTimer() {
        mWait_AvnBrightValueChagedDown = true;
        mOneShotTimerWaitAvnAutoBrightValueChanged100ms.start();
    }

    void cancelWaitAvnBrightValueChanged100ms() {
        mOneShotTimerWaitAvnAutoBrightValueChanged100ms.stop();
        mWait_AvnBrightValueChagedUp = false;
        mWait_AvnBrightValueChagedDown = false;
    }
    ...
    void onOneShotTimerWaitAvnAutoBrightValueChanged100msChanged() {
        mWait_AvnBrightValueChagedUp = false;
        mWait_AvnBrightValueChagedDown = false;
    }
    ...
    void updateRheostatFeedbackEventNoAVN() {
        if (mConfigAvnBrightLink == ConfigAvnBrightLink::OFF &&
            mInter_MinLightMode == SFCIllumination_CVInter_MinLightMode::OFF) {
            if (mRheostatSwitchPrevious == RheostatSwitch::DEFAULT && mRheostatSwitch == RheostatSwitch::UP) {
                if ((mConfigAutolight == ConfigAutolight::ON && mInter_RheostatLevelStatus == 20) ||
                    mInter_RheostatLevelStatus == 21) {
                    setSFCIllumination_CVEventRheostatFeedbackNoAVNLinkedSoundType(
                        SFCIllumination_CVEventRheostatFeedbackNoAVNLinkedSoundType::REPEAT_COUNT);
                } else {
                    setSFCIllumination_CVEventRheostatFeedbackNoAVNLinkedSoundType(
                        SFCIllumination_CVEventRheostatFeedbackNoAVNLinkedSoundType::NONE);
                }
                setSFCIllumination_CVEventRheostatFeedbackNoAVNStat(SFCIllumination_CVEventRheostatFeedbackNoAVNStat::ON);
                mForceUpdateGroup = true;
            } else if (mRheostatSwitchPrevious == RheostatSwitch::DEFAULT && mRheostatSwitch == RheostatSwitch::DOWN) {
                if (mInter_RheostatLevelStatus == 1) {
                    setSFCIllumination_CVEventRheostatFeedbackNoAVNLinkedSoundType(
                        SFCIllumination_CVEventRheostatFeedbackNoAVNLinkedSoundType::REPEAT_COUNT);
                } else {
                    setSFCIllumination_CVEventRheostatFeedbackNoAVNLinkedSoundType(
    ...
    void updateRheostatFeedbackEventAvnLink() {
        if (mConfigAvnBrightLink == ConfigAvnBrightLink::ON && mInter_MinLightMode == SFCIllumination_CVInter_MinLightMode::OFF) {
            if ((mRheostatSwitchPrevious == RheostatSwitch::DEFAULT && mRheostatSwitch == RheostatSwitch::UP) ||
                mWait_AvnBrightValueChagedUp == true) {
                if (mIMG_ClusterLightingLevel_Stat == 100) {
                    setSFCIllumination_CVEventRheostatFeedbackAvnLinkLinkedSoundType(
                        SFCIllumination_CVEventRheostatFeedbackAvnLinkLinkedSoundType::REPEAT_COUNT);
                } else {
                    setSFCIllumination_CVEventRheostatFeedbackAvnLinkLinkedSoundType(
                        SFCIllumination_CVEventRheostatFeedbackAvnLinkLinkedSoundType::NONE);
                }
                setSFCIllumination_CVEventRheostatFeedbackAvnLinkStat(SFCIllumination_CVEventRheostatFeedbackAvnLinkStat::ON);
                mForceUpdateGroup = true;
            } else if ((mRheostatSwitchPrevious == RheostatSwitch::DEFAULT && mRheostatSwitch == RheostatSwitch::DOWN) ||
                       mWait_AvnBrightValueChagedDown == true) {
                if (0 <= mIMG_ClusterLightingLevel_Stat && mIMG_ClusterLightingLevel_Stat <= 1) {
                    setSFCIllumination_CVEventRheostatFeedbackAvnLinkLinkedSoundType(
                        SFCIllumination_CVEventRheostatFeedbackAvnLinkLinkedSoundType::REPEAT_COUNT);
                } else {
                    setSFCIllumination_CVEventRheostatFeedbackAvnLinkLinkedSoundType(
    ...
    using InteriorLampOnReqStatus = ArgumentsDayAndNightModeChanged::Input_InteriorLampOnReqStatus;
    ...
    SFCIllumination_CVInter_IllCluster mInter_IllCluster = SFCIllumination_CVInter_IllCluster::NIGHT;
    ...
    SFCIllumination_CVInter_MinLightMode mInter_MinLightMode = SFCIllumination_CVInter_MinLightMode::OFF;
    ...
    InteriorLampOnReqStatus mInteriorLampOnReqStatus = InteriorLampOnReqStatus::OFF;
    ...
    HUInt64 mInter_ClusterLightingLevel = 450;
    ...
    HUInt64 mPar_DimmingRateValue = 0;

    // EXNCP-711 : illumination_CV_transition_coefficient.png 기반으로 작성됨
    ...
    std::array<uint16_t, kClusterLightingLevelCount> mClusterLightingLevelDayTableArray = {
        450, 465, 480, 495, 510, 530, 550, 570, 590, 615, 640, 665, 695, 725, 760, 795, 835, 880, 935, 1000};
    ...
    ssfs::SFCTimer<Illumination_CV> mRepeatTimerTransitionLogStyleDialTimerEvery100ms;
    ssfs::SFCTimer<Illumination_CV> mRepeatTimerTransitionExpStyleDialTimerEvery100ms;
    ...
    ssfs::SFCTimer<Illumination_CV> mRepeatTimerTransitionLogStylePointerTimerEvery100ms;
    ssfs::SFCTimer<Illumination_CV> mRepeatTimerTransitionExpStylePointerTimerEvery100ms;

    ssfs::SFCTimer<Illumination_CV> mOneShotTimerIgnElapsedOn400ms;
    ssfs::SFCTimer<Illumination_CV> mOneShotTimerPrivate_DialLightingStatusTurningOn2000ms;
    ssfs::SFCTimer<Illumination_CV> mOneShotTimerPrivate_DialLightingStatusTurningOff2000ms;
    ssfs::SFCTimer<Illumination_CV> mOneShotTimerPrivate_RheostatSwitchOperation500ms;
    ssfs::SFCTimer<Illumination_CV> mOneShotTimerBlinkPrivate_RheostatSwitchOperation;
    ssfs::SFCTimer<Illumination_CV> mOneShotTimerWaitAvnAutoBrightValueChanged100ms;

    ssfs::SFCTimer<Illumination_CV> mOneShotTimerInter_EventInfoDisplayStatusOff5000ms;
    ssfs::SFCTimer<Illumination_CV> mOneShotTimerPrivate_IgOffDisplayOnStatusOff5000ms;
    HBool mInter_EventInfoDisplayStatusOff5000ms = false;
    HBool mPrivate_IgOffDisplayOnStatusOff5000ms = false;
    HBool mWait_AvnBrightValueChagedUp = false;
    HBool mWait_AvnBrightValueChagedDown = false;
    ...
    static constexpr HUInt64 kTimerWaitAvnAutoBrightValueChanged100ms = 100;
    static constexpr HUInt64 kRheostatLevelStep1 = 1;

    HBool mAEMInitializeComplete = false;

    // 4.4.2.1.2 스위치 동작 이벤트 정의 - Blink 처리 변수
